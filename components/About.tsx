...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 relative">
      {/* Pattern background */}
      <div className="absolute inset-0 dark:bg-dot-white/[0.18] bg-dot-black/[0.2]">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-10 mb-20">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.7 }}
          >
            <h3 className="text-3xl font-bold mb-4">Hi, I'm Kishan</h3>
            ...
            <p className="text-zinc-400 mb-8">
              With over 5 years of experience in the tech industry, I've worked on various projects ranging from enterprise-level applications to cutting-edge blockchain solutions. I'm constantly exploring new technologies and methodologies to stay at the forefront of innovation.
            </p>
            
            <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl p-6 border border-zinc-800/80 mb-8">
            ...
            <div className="flex gap-4">
              ...
              />
              <SocialLink 
                icon={<SiHashnode className="text-xl" />} 
